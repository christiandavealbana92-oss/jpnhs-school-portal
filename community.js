...
function buildCompose(){
 const canPost=!!state.user && ["Administrator","Registrar","Teacher"].includes(String(state.user.role||""));
 if(!canPost)return state.user?`<div class="community-compose"><strong>School Community</strong><div class="community-login-note">Students can view school posts and announcements, but only Administrator, Registrar, and Teacher accounts can publish.</div></div>`:`<div class="community-compose"><strong>Sign in through your school portal to post.</strong><div class="community-login-note">Only Administrator, Registrar, and Teacher accounts can publish. Students can view posts only.</div></div>`;
 if(!state.user)return `<div class="community-compose"><strong>Sign in through your school portal to post.</strong><div class="community-login-note">The main school page is available for viewing. Posting is available only from Administrator, Registrar, and Teacher portals after login.</div></div>`;
...
function injectPortal(){
 ...
 if(nav&&!q("[data-page='community']")){
   const b=document.createElement("button");b.className="nav-button";b.dataset.page="community";b.innerHTML=`Post <span class="community-nav-badge" data-community-badge style="display:none">0</span>`;
   nav.appendChild(b);
