...
(function(){
 ...
 if(!school) console.warn('[PortalAuth] Missing school ID. Open the portal with ?school=312422 (or another registered school ID).');
 ...
 window.PortalAuth={ready:true,db,auth,school,findRecord,createAccount,signIn,logout:async()=>{sessionStorage.removeItem('schoolPortalAuth');await auth.signOut()}};
})();
